 ...
 */
class Pluf_GraphQl_Schema_Pluf_Paginator_SDP_Category {
    public function render($rootValue, $query) {
        ...
        $User_Account = new ObjectType([
            'name' => 'User_Account',
            'fields' => function () use (&$User_Group, &$User_Role, &$Tenant_Comment, &$User_Message, &$User_Profile, &$User_Avatar, &$CMS_Content, &$Bank_Wallet, &$Bank_Transfer, &$SDP_Link, &$SDP_Profile){
                return [
                    // List of basic fields
        ...
        $SDP_Asset = new ObjectType([
            ...
            'fields' => function () use (&$SDP_Asset, &$CMS_Content, &$SDP_Drive, &$SDP_Link, &$SDP_Category, &$SDP_Tag){
                return [
                    ...
                    //type: Array(    [type] => Pluf_DB_Field_Varchar    [is_null] =>     [default] => file    [size] => 250    [editable] =>     [readable] => 1)
                    'type' => [
                        'type' => Type::string(),
                        'resolve' => function ($root) {
                            return $root->type;
        ...
        ]);$itemType =$SDP_Category;$rootType =new ObjectType([
            'name' => 'Pluf_paginator',
